...
class VisualizeImageMaximizeFmap(object):
    ...
    def find_n_feature_map(self,layer_name,max_nfmap, model):
        '''
    ...
    def find_images(self,input_img,layer_names,layer_dict, max_nfmap, model,
        ...
        for layer_name in layer_names: ## the layer to visualize
            n_fmap = self.find_n_feature_map(layer_name,max_nfmap,model)
